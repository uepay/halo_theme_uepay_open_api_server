<link rel="stylesheet" href="${static!}/source/css/ad.css?version=1">
<div>
    <section class="hero is-medium">
        <div class="hero-body">
            <div class="container has-text-centered">
                ...
                <p class="subtitle">
                    An excellent open source blog publishing application.
                </p>
                <a class="button" href="https://halo.run/archives/install-quick-start">快速开始</a>
            </div>
        </div>
    </section>
    <section class="body-content" style="margin-top: 50px">
            ...
            <div class="tile is-ancestor">
                ...
                <div class="tile is-parent">
                    <article class="tile is-child box">
                        ...
                        <div class="detail-content">
                            <p>实测在开发环境下（2g RAM/i7 6500u），使用 Apache Benchmark 测试 100 个并发 10000 次请求，吞吐量（Requests per
                                second）在 147.65/sec。</p>
                        </div>
                    </article>
                </div>
                <div class="tile is-parent">
